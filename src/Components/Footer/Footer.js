...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-slate-400 dark:text-gray-900">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">BD DEVELOPERS</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase dark:text-gray-900 font-bold">Course</h3>
                            <ul className="space-y-1">
                                <li>
                                    <Link to='/category/1'>HTML</Link>
                                </li>
                                <li>
                                    <Link to='/category/2'>CSS</Link>
                                </li>
                                <li>
                                    <Link to='/category/3'>React</Link>
                                </li>
                                <li>
                                    <Link to='/category/4'>JavaScript</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                        ...
                        <div className="space-y-3 ">
                            <h1 className="uppercase text-left dark:text-gray-900">Social media</h1>
